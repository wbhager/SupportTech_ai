...
6/16: Initialized db.py to connect to postgres and exposes functions for manipulating data, created a conversations, messages, and evaluation table to store long-term memory and evaluation data,
